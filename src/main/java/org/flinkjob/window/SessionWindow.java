...
public class SessionWindow {
    public static void main(String[] args) throws Exception {
        ...
        stream.print();
        stream.windowAll(ProcessingTimeSessionWindows.withGap(Time.seconds(10))).apply(new AllWindowFunction<String, String, TimeWindow>() {
            @Override
            public void apply(TimeWindow arg0, Iterable<String> input, Collector<String> output) throws Exception {
                ...
                output.collect(new Date(arg0.getStart()) + ":" + new Date(arg0.getEnd()) + ":sum" + String.valueOf(sum));
            }
        }).print();
